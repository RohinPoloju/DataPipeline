...
load data inpath '/user/cloudera/sqoop_import/retailDB/order_items' into table order_items;
load data inpath '/user/cloudera/sqoop_import/retailDB/orders' into table orders;
load data inpath '/user/cloudera/sqoop_import/retailDB/products' into table products;
